...
./actions/organisational-role-assignment.sh "${CASE_WORKER_USER}" "${CASE_WORKER_PASSWORD}" "PUBLIC" "caseworker-sscs-registrar" '{"jurisdiction":"SSCS","primaryLocation":"765324"}'
